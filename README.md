    ...
    <v-card>
      ...
      <div class="pa-4">
        <div class="chips-container">
          <v-chip
              class="custom-chip"
              :class="{ 'custom-active-chip': selectedFilters.includes('calculations') }"
              @click="toggleFilter('calculations')"
          >
            Расчеты
          </v-chip>
          ...
          <v-chip
              class="custom-chip"
              :class="{ 'custom-active-chip': selectedFilters.includes('dm') }"
              @click="toggleFilter('dm')"
          >
            ДМ
          </v-chip>
          ...
          <v-chip
              class="custom-chip"
              :class="{ 'custom-active-chip': selectedFilters.includes('ts') }"
              @click="toggleFilter('ts')"
          >
            ТС
          </v-chip>
        </div>
  ...
  methods: {
    ...
    applyFilters() {
      if (this.selectedFilters.length === 0) {
        // Если фильтры не выбраны - показываем все элементы
